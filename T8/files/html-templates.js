    ...
    <html>
        ...
        <body>
                    ...
                    <div class="row">
                        <div class="w3-row w3-margin-bottom">
                            ...
                            <div class="w3-col s9 w3-border">
                                <input class="w3-input w3-border w3-light-grey" type="text" name="desc"></label>
                            </div>
                        </div>    
                        ...
                        <div class="w3-row w3-margin-bottom">
                            ...
                            <div class="w3-col s9 w3-border">
                                <input class="w3-input w3-border w3-light-grey" type="file" name="myFile"></label>
                            </div>
                        </div>
                    </div>
                </div>
                <input class="maisum w3-btn w3-blue-grey" type="button" value="Mais Um Ficheiro"/>
            ...
            <script type="text/javascript">
                    ...
                    $(document).on("click",".maisum", function () {
